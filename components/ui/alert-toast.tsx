          ...
          return (
               ...
               >
                    ...
                    <div className="flex-shrink-0">
                         <Icon className={cn("h-6 w-6", iconColorClasses[sV][v])} aria-hidden="true" />
                    </div>
                    ...
                    <div className="flex-shrink-0">
                         <button
                              ...
                              className={cn(
                                   ...
                                   sV === 'default' ? "text-foreground/70 hover:bg-muted" : "hover:bg-black/20"
                              )}
                         >
                              <X className="h-5 w-5" />
                         </button>
